...
class GSMDecoder:
    def __init__(self):
        grid = xr.open_dataset(f"{ROOTDIR}/master/gridGSM.nc")
        ...
        self.N_grib = len(self.gsm_suffix)
    ...
    def grib2_to_netcdf(
        ...
        bufs = []
        for suffx in self.gsm_suffix:
            filename = f"{GSMDIR}/Z__C_RJTD_{iyy:04d}{im:02d}{iday:02d}{hour:02d}{minute:02d}00_GSM_GPV_Rjp_Lsurf_FD{suffx}_grib2.bin"
        ...
        values = {
            ...
            "ps": (
                ...
                {"units": "Pa", "long name": "Pressure reduced to MSL"},
            )        
        }
        attrs = {
            "title": "JMA GSM GPV",
